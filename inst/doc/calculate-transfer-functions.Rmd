...
[github page](https://bitbucket.org/ecus/simproxyage/src/master/) for
**simproxyage** and install the package using `devtools::install_github`.
...
Münch, T. and Laepple, T.: What climate signal is contained in decadal to
  centennial scale isotope variations from Antarctic ice cores?, Climate of the
  Past, accepted for publication,
  doi: [10.5194/cp-2018-112](https://doi.org/10.5194/cp-2018-112), 2018.
