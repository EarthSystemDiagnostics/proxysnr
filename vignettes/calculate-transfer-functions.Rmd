...
This vignette explains for the effects of vapour diffusion and time uncertainty
the calculation of spectral transfer functions which describe the expected loss
in spectral power as a function of frequency for these two processes. For time
uncertainty, the loss applies to the spectrum of the common signal recorded by
the spatial average of an array of proxy records (the "stacked" record); for
diffusion, it applies to the loss in average spectral power of the individual
records. Proxy records refer here, more specifically, to any proxy time series
that are based on layer counting in the case of time uncertainty and to stable
isotope records from firn/ice cores in the case of diffusion.
