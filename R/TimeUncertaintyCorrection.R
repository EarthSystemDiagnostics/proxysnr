...
##' is available on Bitbucket under \url{https://bitbucket.org/ecus/trenchr} and
...
##' details):
##' 
##' The function allows one to model the age uncertainty with
...
##' at the core top), constrained age perturbation
