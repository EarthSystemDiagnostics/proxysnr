...
#'   (see section "Value" under \code{?ObtainArraySpectra}), but you can
...
#'   (\code{?spec.object}). In the former case, the measurement noise is
...
#'   cores: \code{?CalculateDiffusionTF}. Internally, the inverse of the
